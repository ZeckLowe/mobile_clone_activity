...
class DisplaySongs extends ConsumerWidget {
  const DisplaySongs({
    super.key,
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) => ListTile(
          ...
          trailing: GestureDetector(
            onTap: () async {
              final int id = ref.watch(clickedPlaylistId);
              print(id);
              await ref
                  .read(addPlaylistProvider.notifier)
                  .addSongToPlaylist(id, filteredSongs[index].id!);
            },
            child: Container(
              height: 50,
              width: 50,
